...
export const ToolsView = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      toolsList.map(tool => {
        ...
        return React.createElement(
          'button',
          {
            ...
            className: `p-4 rounded-2xl border text-left transition-all duration-200 flex flex-col justify-between space-y-2 ${
              isActive
                ...
                : 'bg-white dark:bg-slate-900/60 border-slate-200/80 dark:border-slate-800 hover:border-indigo-300'
            }`
          },
          React.createElement(
            'div',
            { className: 'flex items-center justify-between' },
            React.createElement('i', { className: `fas ${tool.icon} text-lg ${isActive ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400'}` }),
          ...
          React.createElement('span', { className: `text-xs font-bold ${isActive ? 'text-slate-900 dark:text-slate-100' : 'text-slate-600 dark:text-slate-400'}` }, tool.title)
        );
      })
    ),
    ...
    activeTool === 'calculus' && React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-2' },
        React.createElement('h3', { className: 'font-black text-base text-slate-800 dark:text-slate-100 flex items-center gap-2' },
    ...
    activeTool === 'derivative_calc' && React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'lg:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-5' },
        React.createElement('h3', { className: 'font-black text-base text-slate-800 dark:text-slate-100' }, 'Kvadratik Funksiya və Törəmə Tənliyi'),
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'a əmsalı:'),
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'b əmsalı:'),
            React.createElement('input', {
              type: 'number',
              value: polyB,
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'c sərbəst həd:'),
            React.createElement('input', {
              type: 'number',
              value: polyC,
        ...
        React.createElement(
          'div',
          null,
          React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'Toxunma nöqtəsi (x₀):'),
          React.createElement('input', {
            type: 'number',
            value: evalX,
      ...
      React.createElement(
        'div',
        { className: 'lg:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-indigo-200 dark:border-indigo-900 shadow-sm space-y-4' },
        ...
        React.createElement(
          ...
          React.createElement('div', { className: 'text-xs text-slate-500' }, 'Funksiya:'),
          React.createElement(KatexRenderer, { text: `$$f(x) = ${polyA}x^2 + (${polyB})x + (${polyC})$$`, block: true }),
          React.createElement('div', { className: 'text-xs text-slate-500' }, 'Törəmə Funksiyası:'),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('div', { className: 'text-[11px] font-bold text-slate-400 uppercase' }, 'f(x₀) Qiyməti'),
            React.createElement('div', { className: 'text-2xl font-black text-indigo-600 dark:text-indigo-400 mt-1' }, funcValue)
          ),
          React.createElement(
            'div',
            { className: 'p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700' },
            React.createElement('div', { className: 'text-[11px] font-bold text-slate-400 uppercase' }, 'Bucaq Əmsalı (k = f\'(x₀))'),
    ...
    activeTool === 'physics_sim' && React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm' },
        React.createElement('h3', { className: 'font-black text-base text-slate-800 dark:text-slate-100 flex items-center gap-2' },
    ...
    activeTool === 'geometry' && React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'lg:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4' },
        React.createElement('h3', { className: 'font-black text-base text-slate-800 dark:text-slate-100' }, 'Düzbucaqlı Üçbucaq və Çevrə Parametrləri'),
        React.createElement('p', { className: 'text-xs text-slate-400' },
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'Katet a:'),
            React.createElement('input', {
              type: 'number',
              value: geomA,
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label', { className: 'block text-[11px] font-bold text-slate-500 mb-1' }, 'Katet b:'),
            React.createElement('input', {
              type: 'number',
              value: geomB,
      ...
      React.createElement(
        'div',
        { className: 'lg:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-amber-200 dark:border-amber-900 shadow-sm space-y-4' },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('div', { className: 'text-slate-400 text-[10px] uppercase font-bold' }, 'Hipotenuz (c = √(a²+b²))'),
            React.createElement('div', { className: 'text-xl font-black text-indigo-600 dark:text-indigo-400 mt-1' }, geomC.toFixed(2))
          ),
          React.createElement(
            'div',
            { className: 'p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700' },
            React.createElement('div', { className: 'text-slate-400 text-[10px] uppercase font-bold' }, 'Üçbucağın Sahəsi (S = ab/2)'),
            React.createElement('div', { className: 'text-xl font-black text-emerald-600 dark:text-emerald-400 mt-1' }, geomArea.toFixed(2))
          ),
          React.createElement(
            'div',
            { className: 'p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700' },
            React.createElement('div', { className: 'text-slate-400 text-[10px] uppercase font-bold' }, 'Xaricə Çəkilmiş Çevrə (R = c/2)'),
            React.createElement('div', { className: 'text-xl font-black text-amber-600 dark:text-amber-400 mt-1' }, geomR.toFixed(2))
          ),
          React.createElement(
            'div',
            { className: 'p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700' },
            React.createElement('div', { className: 'text-slate-400 text-[10px] uppercase font-bold' }, 'Daxilə Çəkilmiş Çevrə (r)'),
